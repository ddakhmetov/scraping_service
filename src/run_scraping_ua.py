...
sys.path.append(proj)   #Для запуска файла вне Django. Подставляем путь
...
from scraping.models import Vacancy, City, Language, Url_kz, \
    Errors  # Обращаться к файлам проекта нужно после запуска Django
